...
int main(int argc, char **argv) {
  ...
  printf("Running 4x GStreamer CPU Copy with detailed performance logging... "
  ...
  while (running) {
    ...
    if (get_diff_us(second_start, second_end) >=
    ...
    // Optional: Add a small delay to make output readable
